...
def edit_workspace(workspace_id):
    ...
    _updateNameForm.submit.label = Label(_updateNameForm.submit.id, 'Save Name')
    ...
    return render_template('editWorkspace.html',workspace_id = workspace_id, updateWorkspaceNameForm = _updateNameForm, new_member_form = _new_member_form, 
...
@admin_bp.post('/<int:member_id>/edit_workspace/remove_member')
@login_required
